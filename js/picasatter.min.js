...
function fetch_main_window(id, src, summary, team){
    ...
    $("#main_window, .subwindow").fadeOut(200, function(){
        ...
        else $(this).attr("src", "./images/" + window.picasatter['class'][team-1] + ".jpg");
        $(this).fadeIn(200);
      }
    );
...
$(document).ready(function(){
    ...
    window.picasatter['class'] = ['mickey', 'minny', 'tiger', 'dumbo', 'marry'];
