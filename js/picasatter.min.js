...
function fetch_main_window(id, src, team, summary){
    ...
    $.getJSON(url,function(json){
        ...
        $(json.feed.entry).each(function(){
	        ...
	        var thedatestr = thedate.getHours()+':'+thedate.getMinutes();
                ...
                elem.prepend(divstr);
                $('#tw'+id, elem).hide();
                $('#tw'+id, elem).bind("click", function(){fetch_main_window(id, src, team);});
                $('#tw'+id+' img',elem).hide();
...
$(document).ready(function(){
    ...
    $('.photo').each(function(e){
        rrp = 6;
        elem = $(this);
        window.picasatter['timeout'] = (timeout=elem.attr('timeout'))? timeout : 1000 ;
