...
function fetch_photos(elem){
    ...
    $.getJSON(url,function(json){
        ...
        if(elem.attr('f')=="slideshow"){
            //$(json.feed.entry).sort(sort_by('gphoto$id.$t', function(){ Math.random() - Math.random() }));
            //to do shuffle sort
        ...
        $(json.feed.entry).each(function(){
	        ...
	        var thedatestr = thedate.getHours()+':'+thedate.getMinutes();
                //var thedatestr=thedate.getHours()+':'+thedate.getMinutes();
                var divstr = '<div id="tw'+this.gphoto$id.$t+'" class="tweet"><img width="512" height="384" src="'+
...
$(document).ready(function(){
    ...
    $('.picasatter').each(function(e){
        rrp = 6;
        elem = $(this);
        window.picasatter['timeout'] = (timeout=elem.attr('timeout'))? timeout : 2000 ;
        if(elem.attr('f')=='slideshow'){
            slide_show(this);
        }else{
            fetch_photos(this);
